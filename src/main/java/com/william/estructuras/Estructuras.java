...
public class Estructuras {
    ...
    public static void main(String[] args) {
        ...
        DoublyLinkedList lde = new DoublyLinkedList(); 
        ...
        do{
            try{
                ...
                switch(opcion){
                    ...
                    case 5 -> {
                        if(!lde.isEmpty()){
                            JOptionPane.showMessageDialog(null, "El tamaño de la lista es: " + lde.size(), 
                    ...
                    case 7 -> {
                        elemento = Integer.parseInt(JOptionPane.showInputDialog(null, "Buscar por valor",
                                ...
                                lde.searchByValue(elemento);
                                JOptionPane.showMessageDialog(null, "El elemento buscado es: " + lde.searchByValue(elemento), 
                    ...
                    case 8 -> {
                        elemento = Integer.parseInt(JOptionPane.showInputDialog(null, "Buscar por indice",
                                ...
                                lde.searchByIndex(elemento);
                                JOptionPane.showMessageDialog(null, "El elemento buscado es: " + lde.searchByIndex(elemento), 
                                "Elemento encontrado", JOptionPane.INFORMATION_MESSAGE); 
                        break;
                    }
